...
def import_labelled_csv(
    ...
    # Insert the extracted training samples in ONE PostgreSQL request.
    # This is much faster and more reliable on hosted Render/Supabase than
    # executing one network round-trip per training sample.
    values = [
        (
            fingerprint,
            parsed["filename"],
